...
//imports statements for path, mimetype and multer
...
const fileStorage = multer.diskStorage({
    ...
    cb(null, 'uploads/'); //specify the destination directory for the uploads
    },
    filename: function (req, file, cb) {
    cb(null, file.originalname); //use the orginal name of the file
    },
});
...
//set the correst MIME type for the uploaded file
